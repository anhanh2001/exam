                        ...
                        <table class="user-list-table table" id="">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-warning" href="{{route('role.edit',$c->id)}}">Sửa</a>&nbsp<a onclick="return confirm('Bạn có chắc chắn muốn xóa ?');" href="{{route('role.remove',$c->id)}}" class="btn btn-danger">Xóa</a></td>
                                </tr>
                                @endforeach
                            </tbody>
